...
export default function ThirdSection() {
    return (
        <div className="bg-slate-100 dark:bg-lighter-black text-black dark:text-white flex flex-col justify-center items-center pt-20 pb-20">
            <h1 className="text-5xl font-bold">Preço Simples e Transparente</h1>
            <h3 className="text-slate-500 dark:text-slate-300 text-base pt-6 max-w-[41%]">Pra que inúmeros planos quando nós sabemos exatamente o que é melhor para você?
